      ...
      <PageMarginWithTitle>
        <Grid className='mt-30 md:mt-50'>
          ...
          <div className='col-span-2 md:col-span-6 order-2'>
            <span className='text-body-regular font-light md:font-light md:text-h5 tracking-normal md:whitespace-pre-wrap xl:whitespace-normal'>
              {
                'Большая Новодмитровская улица находится в Бутырском районе на севере Москвы. \nК ней примыкают такие знаковые городские пространства как арт-квартал «Хлебозавод», дизайн-завод «Флакон», Савёловский вокзал и ряд офисных центров.'
              }
            </span>
          </div>
        ...
        <Grid className='mt-30 md:mt-50'>
          ...
          <div className='col-span-2 md:col-span-7'>
            <span className='text-body-regular-mob md:text-body-regular font-light lg:text-h5'>
              ...
              практически все креативно-технологические мастерские, которые
              позволят и дальше развиваться кварталу. Сейчас ведутся работы по
              изменению структуры завода.
            </span>
          </div>
        </Grid>
