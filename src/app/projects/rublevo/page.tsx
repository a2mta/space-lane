        ...
        <Grid className='md:mt-50'>
          <div className='col-span-2 md:col-span-4 flex flex-col'>
            <span className='text-body-regular-mob md:text-body-regular font-light block md:whitespace-pre-wrap'>
              {
                'Для планирования, подготовки и проектирования благоустройства уличных общественных пространств было выделено 4 типа улиц. В основе типологизации лежат такие параметры, как пешеходная и транспортная активность, функции окружающий зданий. \nЭто позволило сформулировать специфику функционирования зданий каждой улицы, которая нашла отражение в решениях, предусмотренных для каждого типа.'
              }
            </span>
          </div>
