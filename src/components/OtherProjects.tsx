...
const OtherProjects = () => {
  ...
  const prname = getActiveProject();
  const projects = unfilteredProj.filter(({ link }) => link !== prname);
      ...
      <Grid>
        <div className='col-span-2 md:col-span-12 mb-10 md:mb-16'>
          <div className='flex justify-between items-center'>
            <span className='text-h3-mob md:text-h4 font-medium'>Другие проекты</span>
